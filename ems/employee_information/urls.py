...
urlpatterns = [
    ...
    path('download-employees-pdf/', views.download_employees_pdf, name='download_employees_pdf'),
    path('employee/download/<int:employee_id>/', views.download_employee_pdf, name='download_employee_pdf'),
]